<script lang="ts">
  ...
  import { convert, makeColor, type Color } from '../../color'
  import { CHROMA_MAX } from '../../color/constants'
  import { toCss, toHex } from '../../color/serialize'
  import { inSrgb, inP3, clipTo, maxChromaIn } from '../../color/gamut'
  import {
  ...
  import IconCopy from '../../icons/20-copy.svg?raw'
  import IconDone from '../../icons/20-done.svg?raw'
  import IconLock from '../../icons/20-lock.svg?raw'
  import IconLockUnlocked from '../../icons/20-lock-unlocked.svg?raw'
...
<style>.popover {
  ...
  animation: color-picker-appear 250ms cubic-bezier(0.42, 1.67, 0.21, 0.9);
}
