<script lang="ts">
  import type { ContrastResult, WcagLevel } from '@lib/color'
  ...
  import IconTune from '@lib/icons/20-tune.svg?raw'
...
.preview
  ...
  line-height: 1
  flex-shrink: 0
  // The preview itself IS the visual contrast demo, so the actual
  // bg + fg colors stay in the inline style.
